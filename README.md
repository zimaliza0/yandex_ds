...
| 05 | [Рекомендация тарифов](/05-classifying-profitable-plan) <br/><br/>> [посмотреть тетрадь](ссылка) | Построить модель для задачи классификации, которая подскажет подходящий тариф. | `sklearn`, `matplotlib`, `numpy`, `pandas` |
